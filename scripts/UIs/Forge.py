...
def unpack_webui():
    ...
    if WEBUI.exists():
        print(f"--- [{UI}.py] Directory {WEBUI} already exists. Assuming Forge is already cloned. ---")
    else:
        try:
    ...
    if install_script.exists():
        ...
        try:
            ...
            if process.returncode == 0:
                ...
                print(f"--- [{UI}.py] Forge {install_script} completed with return code {process.returncode} ---", file=sys.stderr)
